...
By default, a hashref is returned containing field names and its values, e.g.
C<{group=>"neil", pass=>"x", gid=>500, ...}>. With C<with_field_names=>0>, an
arrayref is returned instead: C<["neil", "x", 500, ...]>.
...
By default, a hashref is returned containing field names and its values, e.g.
C<{user=>"neil", pass=>"x", uid=>500, ...}>. With C<with_field_names=>0>, an
arrayref is returned instead: C<["neil", "x", 500, ...]>.
...
By default, when C<detail=>1>, a hashref is returned for each entry containing
field names and its values, e.g. C<{user=>"neil", pass=>"x", uid=>500, ...}>.
With C<with_field_names=>0>, an arrayref is returned instead: C<["neil", "x", 500,
...]>.
